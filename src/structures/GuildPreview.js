...
class GuildPreview extends Base {
  ...
  splashURL(options = {}) {
    return (
      this.splash &&
      (/^https?:\/\//.test(this.splash) ? this.splash : this.client.rest.cdn.splash(this.id, this.splash, options))
    );
  }
  ...
  discoverySplashURL(options = {}) {
    return (
      ...
      (/^https?:\/\//.test(this.discoverySplash)
        ? this.discoverySplash
        : this.client.rest.cdn.discoverySplash(this.id, this.discoverySplash, options))
    );
  }
  ...
  iconURL(options = {}) {
    return (
      this.icon &&
      (/^https?:\/\//.test(this.icon) ? this.icon : this.client.rest.cdn.icon(this.id, this.icon, options))
    );
  }
