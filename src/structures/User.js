...
class User extends Base {
  ...
  avatarURL(options = {}) {
    return (
      this.avatar &&
      (/^https?:\/\//.test(this.avatar) ? this.avatar : this.client.rest.cdn.avatar(this.id, this.avatar, options))
    );
  }
  ...
  bannerURL(options = {}) {
    return (
      this.banner &&
      (/^https?:\/\//.test(this.banner) ? this.banner : this.client.rest.cdn.banner(this.id, this.banner, options))
    );
  }
  ...
  guildTagBadgeURL(options = {}) {
    return this.primaryGuild?.badge
      ? (/^https?:\/\//.test(this.primaryGuild.badge)
