...
class GuildMember extends Base {
  ...
  avatarURL(options = {}) {
    return (
      this.avatar &&
      (/^https?:\/\//.test(this.avatar)
        ? this.avatar
        : this.client.rest.cdn.guildMemberAvatar(this.guild.id, this.id, this.avatar, options))
    );
  }
  ...
  bannerURL(options = {}) {
    return (
      this.banner &&
      (/^https?:\/\//.test(this.banner)
        ? this.banner
        : this.client.rest.cdn.guildMemberBanner(this.guild.id, this.id, this.banner, options))
    );
  }
